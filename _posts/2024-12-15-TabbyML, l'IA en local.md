...
> La doc, pour référence: [Installation avec Docker Compose](https://tabby.tabbyml.com/docs/quick-start/installation/docker-compose/)
...
> La doc, pour référence: [Upgrade](https://tabby.tabbyml.com/docs/administration/upgrade/)
...
Voir la doc: [Installation avec Docker](https://tabby.tabbyml.com/docs/quick-start/installation/docker/)

- CPU seulement, en docker:
...
- Avec docker-compose, CPU seulement toujours:
